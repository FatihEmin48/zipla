...
const SHIELD_TIME = 6;        // kalkan (dokunulmazlık) süresi (sn)
const POWERUP = 24;           // güç-yükseltmesi boyutu (px)
...
const LEVELS = [
  ...
  },
  {
    ...
    powerups: [[450, 300, 'shield']],
    coins: [[220, 312], [430, 312], [545, 266], [700, 220], [865, 176], [1040, 136], [1290, 190], [1395, 86], [1560, 56]],
  },
  {
    name: 'Final',
    par: 42,
    width: 2200, height: 384,
    spawn: [40, 300],
    goal: [2120, 296],
    checkpoints: [860, 1680],
    platforms: [
      [0, 352, 340, 32], [450, 352, 300, 32], [860, 352, 300, 32], [1270, 352, 300, 32], [1680, 352, 520, 32], // boşluk 110
      [280, 286, 90, 20], [980, 270, 100, 20], [1160, 250, 100, 20], [1500, 280, 100, 20],
    ],
    hazards: [[600, 336, 48, 16], [1000, 336, 64, 16], [1400, 336, 48, 16]],
    movers: [{ x: 760, y: 290, w: 90, h: 16, axis: 'x', amp: 80, speed: 75 }],
    movingHazards: [{ x: 1310, y: 250, w: 30, h: 30, axis: 'y', amp: 90, speed: 100 }],
    powerups: [[1240, 300, 'shield']],
    enemies: [
      { x: 500, y: 326, w: 26, h: 26, range: 120, speed: 60 },
      { x: 1760, y: 326, w: 26, h: 26, range: 220, speed: 66 },
      { x: 1080, y: 250, w: 26, h: 22, range: 140, speed: 58, type: 'flyer' },
    ],
    coins: [[180, 312], [300, 250], [500, 312], [700, 312], [1010, 234], [1190, 214], [1350, 312], [1530, 244], [1760, 312], [1950, 312], [2080, 312]],
  },
];
